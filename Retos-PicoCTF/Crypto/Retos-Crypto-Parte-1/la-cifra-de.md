...
```
En este reeto nos dan un servicio para conecctarnos a el asi que nos conocemos y vemos lo que nos arroja:
```

```
la-cifra-de % nc jupiter.challenges.picoctf.org 58295
Encrypted message:
...
```
Al parecer nos da mucho texto encriptado asi que lo intentamos desirar.


Metemos el texto a la pagina https://wiremask.eu/tools/vigenere-cracker/
...
![la-cifra-de](/imagenes/la-cifra-de.png)
## Notas adicionales
## Referencias
[wiremask](https://wiremask.eu/tools/vigenere-cracker/)