...
## Solución
En este reto nos dan un archivo .txt que al parecer tiene texto cifrado:
...
Asi que usando [Boxentriq](https://www.boxentriq.com/code-breaking/keyed-caesar-cipher) y pasándole la key DECKFMYIQJRWTZPXGNABUSOLVH que se encuentra al principio del texto desciframos el texto que nos da como resultado:
```
