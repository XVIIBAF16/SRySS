...
```
En este reto nos dan un archivo .pcap y un archivo .key, investigando un poco encontramos el comando ssldump que se utiliza para analizar tráfico SSL/TLS contenido en un archivo de captura pasandole como argumento la clave privada que se utilizará para descifrar el tráfico SSL/TLS.
```
...
Una muestra de lo que arroja el comando
```

```
Si observamos bien nos arroja el contnido desifrado en hexadecimal y texto, analizando un poco nos damos cueenta que la flag se encuentra ahi:
```
